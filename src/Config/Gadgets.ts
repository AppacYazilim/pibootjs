...
export const availableGadgets = [
  {
    ...
    files: {
      ...
      // Cloudflare pages does not support files that are bigger than 25mb :(
      // Todo: add hash checks to validate the file
      'boot.img': "https://cdn.appac.dev/boot.img" //BootImg
    }
  },
  { // does not work yet
    id: "recover_eeprom5",
